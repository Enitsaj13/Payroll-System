      ...
      <div class="container-login100">
        <div class="wrap-login100">
          <div class="login100-pic js-tilt" data-tilt>
            <img src="../assets/images/Enter OTP-cuate.svg" alt="IMG">
          </div>
          ...
          ?>
            ...
            <div class="wrap-input100">
              <input class="input100" type="text" name="email"  spellcheck="false" autocomplete="off" placeholder="Email">
            ...
            <div class="container-login100-form-btn">
              <button type="submit" name="resetpass" class="login100-form-btn">Send Password Reset Link</button>
            </div>
