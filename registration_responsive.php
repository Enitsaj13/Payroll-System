...
<html lang="en">
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="css/registration_responsive.css">
    <!-- Favicon -->
  ...
  <body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div id="ui">
                <form method="POST" action="" enctype='multipart/form-data' class="p-4" id="regform">

                        <h3 class="mb-2 pb-2 pb-md-0 mb-md-5 text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <h6>
                            <label class="form-label" place-holder="ha">Email <span class="text-danger">*</span></label>
                            </h6>
                    ...
                    <input type="submit" name="submit" value="Register" class="btn reg-btn btn-block" style="border-radius: 25px; text-transform: uppercase"></input>
                    <div class="row">
                        
                        <div class="col-md-12 text-center redirect">
                        <label class="registered">Already registered? <a href="index.php">Login</a></label>
                        </div>
                    </div>
