                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        while($row = mysqli_fetch_array($result)){
                                                            ...
                                                            <a name='payroll' href='#update".$row['id']."'class='btn btn-sm btn-success' ' data-toggle='modal'><i class='bx bxs-cog'></i></a>
                                                            <a href='#delete".$row['id']."'class='btn btn-sm btn-danger' data-toggle='modal'><i class='bx bxs-trash'></i></a>
