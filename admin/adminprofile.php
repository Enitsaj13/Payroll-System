            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Admin Details</h3>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <!-- Tab panes -->
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" method="GET" action="profileupdate.php">
                                    ...
                                    <div class="form-group">
                                        <label for="example-email" name="email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="contact" value="<?php echo $_SESSION['user']['contact']; ?>"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="department" value="<?php echo $_SESSION['user']['department']; ?>"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
