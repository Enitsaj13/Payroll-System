            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Payroll Information</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <i class='bx bx-home ms-1 mt-2'></i>
                            <i class='bx bx-chevron-right mt-2'></i>
                            <li class="breadcrumb-item active">Salary, Late, Leave, Absences</li>
                        </ol>
                    </div>
					...
					?>
                            ...
                            <div class="table-responsive-md bg-white">
                                        ...
                                        <h5 class="card-title mb-0">
                                            <a href="../print.php" class="btn btn-info m-2 pull-right">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        while($row = mysqli_fetch_array($result)){
                                                            ...
                                                            #RDW = RATE * DAY WORK
                                                            $get_RDW = $rate*$day_work;
                                                            

                                                            #OTP = Overtime Pay
                                                            $get_OTP = $overtime * 400;
                                                            echo "<td>".$get_OTP."</td>";


                                                            #GROSSPAY COMPUTATION
                                                            $grosspay = $get_RDW + $get_OTP;
                                                            echo "<td>".$grosspay."</td>";
                                                            ...
                                                            #LEAVE COMPUTATION
                                                            $get_LEAVE = ($get_RDW / $day_work)* $leave_number *0.5 ;
                                                            echo "<td>".$get_LEAVE."</td>";

                                                            #ABSENT COMPUTATION
                                                            $get_ABSENCE = ($get_RDW / $day_work)* $absence ;

                                                            echo "<td>".$get_ABSENCE."</td>";
                                                            ...
                                                            else if ($grosspay <= 64999)
                                                            {
                                                                $tax = $grosspay * 0.12;
                                                                
                                                            }
                                                            else if ($grosspay <= 85999)
                                                            {
                                                                $tax = $grosspay * 0.15;
                                                            }
                                                           ...
                                                           #SSS TAX
                                                            ...
                                                            #DEDUCTION TAX
                                                            $DEDUCTION = $grosspay;
                                                            $DEDUCTION=$SSS+$PHILHEALTH+$PAGIBIG+$get_ABSENCE+$get_LEAVE+$get_LATE+$tax;
